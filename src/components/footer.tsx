    ...
    <div className="container-fluid bg-startista p-3 p-lg-5">
      <div className="row d-flex flex-column flex-lg-row justify-content-center">
        <div className="col-12 col-lg-4 d-flex flex-column justify-content-center align-items-center">
          <img src={logoFooter} alt="" className="mb-3 w-100 w-lg-50" />
          <div className="d-flex justify-content-center mb-5">
            <Link to="https://www.facebook.com/StartistaOficial" className="text-decoration-none fa-brands fa-facebook fa-lg rounded-circle text-startista bg-white mx-1"></Link>
            <Link to="https://www.instagram.com/startistaoficial/" className="text-decoration-none fa-brands fa-instagram fa-lg rounded-circle text-startista bg-white mx-1"></Link>
            <Link to="https://www.linkedin.com/company/startista/" className="text-decoration-none fa-brands fa-linkedin fa-lg rounded-circle text-startista bg-white mx-1"></Link>
          </div>
        </div>
        <div className="col-12 col-lg-8 d-flex flex-column justify-content-center">
          <h1 className="fw-bold text-center text-lg-start mb-4">O Startista é um projeto social sem fins lucrativos com a finalidade de ser uma ponte entre os autistas e o mercado de trabalho.</h1>
